...
const expected = ['.nojekyll', 'index.html', 'release.json', 'robots.txt'];
...
console.log(JSON.stringify({ build: release.build, artifactIntegrity: 'PASS', inlineJavaScriptSyntax: 'PASS', cspHash: 'PASS', privateDataPatternScan: 'PASS', browserAcceptance: 'NOT_TESTED', fileCount: expected.length }, null, 2));
